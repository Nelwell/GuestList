package android.bignerdranch.guestlist;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "13852695";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mClearListButton = findViewById(R.id.clear_guest_list_button);
